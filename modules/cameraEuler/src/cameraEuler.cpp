...
const float cameraEuler::camDefault::YAW        = -90.0f;
const float cameraEuler::camDefault::PITCH      = 0.0f;
const float cameraEuler::camDefault::SPEED      = 2.5f;
const float cameraEuler::camDefault::SENSITIVTY = 0.1f;
const float cameraEuler::camDefault::ZOOM       = 45.0f;
// Constructor with vectors
cameraEuler::cameraEuler(glm::vec3 position,
                         glm::vec3 up,
                         float yaw,
                         float pitch)
...
cameraEuler::cameraEuler(float posX,
                         float posY,
                         float posZ,
                         float upX,
                         float upY,
...
// systems)
void cameraEuler::ProcessKeyboard(Camera_Movement direction, float deltaTime)
{
...
void cameraEuler::ProcessMouseMovement(float xoffset,
                                       float yoffset,
