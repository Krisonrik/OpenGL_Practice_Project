...
int main()
{
  ...
  //    "vertex_shader_coordinate-systems.glsl",
  ...
  glUniform1i(glGetUniformLocation(lightingProgram, "ourTexture1"),
              0);  // set it manually
  glUniform1i(glGetUniformLocation(lightingProgram, "ourTexture2"), 1);
