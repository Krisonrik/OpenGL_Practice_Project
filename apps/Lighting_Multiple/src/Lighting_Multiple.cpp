...
int main()
{
  ...
  lightingProgram =
      lightingShader.loadShaders("vertex_shader_lighting_casters.glsl",
                                 "fragment_shader_lighting_casters.glsl");
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    glUniform3f(glGetUniformLocation(lightingProgram, "light.direction"),
                curCam.getFront().x,
                curCam.getFront().y,
                curCam.getFront().z);
    ...
    glUniform1f(glGetUniformLocation(lightingProgram, "light.quadratic"),
                0.032f);
    glUniform1f(glGetUniformLocation(lightingProgram, "light.cutOff"),
                lightCutoff);
    glUniform1f(glGetUniformLocation(lightingProgram, "light.outerCutOff"),
                lightOuterCutoff);
